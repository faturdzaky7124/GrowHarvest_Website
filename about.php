...
.ftco-navbar-light .navbar-nav > .nav-item > .nav-link{
	...
	font-size: 13px;
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="about.php" class="nav-link">Profile</a></li>
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('assets/landingpage/asetLP/img/profile.jpg');">
      <div class="container">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Selamat datang di solusi pertanian modern!</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Pertanian Rajawali.com merupakan toko pertanian online yang menyediakan produk-produk yang dibutuhkan untuk
                pertanian, perikanan, perkebunan, dan peternakan. Kami menjual berbagai macam obat-obatan dan alat pertanian,
                seperti Bibit / Benih,Nutrisi Tanaman, Pakan Ternak, Pestisida (Fungisida, Insektisida, Herbisida, Akarisida, dll), 
                aneka pupuk(pupuk daun, pupuk akar, pupuk ZA, pupuk NPK Yaramila, NPK Mutiara, dll), dan juga alat-alat
                pertanian dengan kualitas terjamin dan harga terjangkau.</p>
      ...
      <div class="container py-4">
		...
		<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(assets/landingpage/images/bg_3.jpg);">
    	<div class="container">
