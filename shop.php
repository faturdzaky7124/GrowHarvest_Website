...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('./asetLp/img/produk1.jpg');">
      <div class="container">
...
<section id="portfolio" class="port mt-5">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-10 mt-3 mb-4 text-center">
				<ul class="" id="portfolio-flters">
					...
					<li data-filter=".filter-Pestisida" class="filter">Pestisida</li>
					<li data-filter=".filter-Benih" class="filter">Benih</li>
					<li data-filter=".filter-Pupuk" class="filter">Pupuk</li>
					<li data-filter=".filter-Alat" class="filter">Alat Pertanian</li>
				</ul>
			</div>
		</div>
		...
		<div class="row portfolio-container">
			...
			<div class="col-md-6 col-lg-3 portfolio-item filter-Pestisida">
				<div class="product">
			...
			<div class="col-md-6 col-lg-3 portfolio-item filter-Benih">
				<div class="product">
			...
			<div class="col-md-6 col-lg-3 portfolio-item filter-Pupuk">
				<div class="product">
			...
			<div class="col-md-6 col-lg-3 portfolio-item filter-Alat">
				<div class="product">
					<a href="#" class="img-prod"><img class="img-fluid" src="images/product-4.jpg" alt="Colorlib Template">
						<div class="overlay"></div>
					</a>
