    		...
    		<div class="row no-gutters d-flex align-items-start align-items-center px-md-0">
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon mr-2 d-flex justify-content-center align-items-center"><span class=""></span></div>
						    <span class="text">Rajawali@gmail.com</span>
					    </div>
...
.ftco-navbar-light .navbar-nav > .nav-item > .nav-link{
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('assets/landingpage/asetLP/img/contact.jpg');">
      <div class="container">
      ...
      <div class="container">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Address:</span> JL.Sukosari no 77 Desa Randuagung,kec.Sumber Jambe,kab.Jember</p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
