	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
		    			<div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon mr-2 d-flex "><span class="icon-phone2"></span></div>
...
.ftco-navbar-light .navbar-nav > .nav-item > .nav-link{
	...
	font-size: 13px;
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav fw-bold ml-auto">
    ...
    <section id="home-section" class="hero">
	      ...
	      <div class="slider-item" style="background-image: url(assets/landingpage/asetLP/img/Home1.jpg);">
	      ...
	      <div class="slider-item" style="background-image: url(assets/landingpage/asetLP/img/Home2.jpg);">
	      	<div class="overlay"></div>
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

	            <div class="col-sm-12 ftco-animate text-center">
	              <h1 class="mb-2">Solusi Pertanian Modern</h1>
	              <h2 class="subheading mb-4"></h2>
	              <p>
					<!-- <a href="#" class="btn btn-primary"></a> -->
				</p>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-4">Produk Teratas</h2>
            <p>Ini adalah beberapapa produk teratas yang ada di toko kami</p>
          </div>
        </div>   		
    	</div>
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="assets/img/imgproduk/IMG-20231126-WA0004.jpg" alt="Colorlib Template">
    						<!-- <span class="status">30%</span> -->
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">pupuk</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="assets/img/imgproduk/IMG-20231126-WA0005.jpg" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="assets/img/imgproduk/IMG-20231126-WA0006.jpg" alt="Colorlib Template">
	    					<div class="overlay"></div>
	    				</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="assets/img/imgproduk/IMG-20231126-WA0007.jpg" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="assets/img/imgproduk/IMG-20231126-WA0008.jpg" alt="Colorlib Template">
    						<!-- <span class="status">30%</span> -->
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="assets/img/imgproduk/IMG-20231126-WA0009.jpg" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="assets/img/imgproduk/IMG-20231126-WA0010.jpg" alt="Colorlib Template">
	    					<div class="overlay"></div>
	    				</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="assets/img/imgproduk/IMG-20231126-WA0011.jpg" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
		...
		<section class="ftco-section img" style="background-image: url(assets/landingpage/images/bg_3.jpg);">
    	<div class="container">
				<div class="row justify-content-end">
          <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
          	<span class="subheading">Solusi Pertanian Milenial</span>
            <h2 class="mb-4">Pertanian Rajawali</h2>
            <p>Produk Terbaik Dengan Pelayanan Terbaik</p>
      ...
      <!-- <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            ...
            <h2 class="mb-4">Orang Orang Yang Puas Dengan Toko Kami</h2>
            <p>Toko Pertanian Rajawali adalah tempat yang luar biasa untuk semua kebutuhan pertanian Anda</p>
          </div>
        </div>
            ...
            <div class="carousel-testimony owl-carousel">
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url(assets/landingpage/images/person_1.jpg)">
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url(assets/landingpage/images/person_2.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url(assets/landingpage/images/person_3.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
