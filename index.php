...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section id="home-section" class="hero">
	      ...
	      <div class="slider-item" style="background-image: url(./asetLP/img/Home1.jpg);">
	      ...
	      <div class="slider-item" style="background-image: url(./asetLP/img/Home2.jpg);">
	      	<div class="overlay"></div>
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="./asetLP/img/bestProduk2.jpg" alt="Colorlib Template">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="./asetLP/img/bestProduk3.jpg" alt="Colorlib Template">
	    					<div class="overlay"></div>
	    				</a>
    					<div class="text py-3 pb-4 px-3 text-center">
